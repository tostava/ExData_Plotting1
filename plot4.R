...
# Set up for plotting 4 graphs on single graphics device.
par(mfrow = c(2,2))

# Plot the data and set up annotation for graph 1
with(dt, 
     plot(datetime,
          Global_active_power,
          type = "l",
...
# Plot the data and set up annotation for graph 2
with(dt, 
     plot(datetime,
          Voltage,
          type = "l",
...
# Plot the data and set up annotation for graph 3
with(dt, 
     plot(datetime,
          Sub_metering_1,
          type = "l",
...
# Plot the data and set up annotation for graph 4
with(dt, 
     plot(datetime,
